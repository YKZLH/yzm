...
function download(url1) {
             ...
             // var url = 'http://111.231.121.36/video/m3u8/2020/04/30/39ddba94/0001.ts';
             // var url='http://111.231.121.36/index.php/play/12.html';
             //var name = 'http://111.231.121.36/video/m3u8/2020/04/30/b2ee528d/0001.ts';
            pos = url1.lastIndexOf('/');//'/所在的最后位置'
            str = url1.substr(pos+1)//截取文件名称字符串
            url2 = url1.substr(0,pos)//截取路径字符串
            url=url2+"/0000.ts"
